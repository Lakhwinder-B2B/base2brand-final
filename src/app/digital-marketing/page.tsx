...
export default function Digital() {
  const PageMeta = {
    ...
    description:
      "Digital Marketing Agency Mohali, Best Digital Marketing Agency Mohali, Digital Marketing Agency",
          ...
          tabbtns.forEach((tabbtn) => {
            ...
            if (tabSectionY < clientHeight && tabSectionY > 272) {
              ...
              if (stepcount > 0) {
                ...
                const stepSection1 = document.querySelector(
                  `.tab1-step-${stepcount}`
                );
            ...
            <div className="row flex-wrap align-items-center m-auto">
              <div className="col-12 col-sm-12 col-md-7 " data-aos="fade-up">
                ...
                <p className="text-white col-12 col-sm-12 col-md-10">
                  Improve Your Online Presence with Our Proven Digital Marketing
                  Strategies. Partner with us for digital marketing excellence
                </p>
                <div className="service-btn d-flex flex-wrap mt-3 w-100">
                  <button className="b2b-btn b2b-btn-sm" onClick={toggleModal}>
                    Request a Quote
                  </button>
          ...
          <div className="b2b-container-lg">
            <div className="gallery_slider">
              <div className="right_slider m-auto">
                <div
                  className="slider_right_main tab1-step-1"
                  data-step="1"
                  data-tab-id="tab1-1"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <h2>Meta Ads</h2>
                        <p>
                          We provide comprehensive social media marketing and
                          advertising services, crafting tailored strategies to
                          elevate your brand's online presence and drive
                          results.
                        </p>
                        <div className="mt-4">
                          <Link
                            href="/underconstrution"
                ...
                <div
                  className="slider_right_main tab1-step-2"
                  data-step="2"
                  data-tab-id="tab1-2"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <h2>Google Ads</h2>
                        <p>
                          Maximize your online visibility with our expert Google
                          Ads management, driving targeted traffic and
                ...
                <div
                  className="slider_right_main tab1-step-3"
                  data-step="3"
                  data-tab-id="tab1-3"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <p>
                          Boost your website's search engine rankings and
                          organic traffic with our customized SEO strategies,
                          tailored to enhance your online visibility and drive
                          conversions.
                        </p>
                        <div className="mt-4">
                          <Link
                ...
                <div
                  className="slider_right_main tab1-step-4"
                  data-step="4"
                  data-tab-id="tab1-4"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <p>
                          Maximize conversions with our CRO. Elevate sales,
                          engage customers, and amplify ROI. Let your brand
                          thrive through data-driven optimization
                        </p>
                        <div className="mt-4">
                          <Link
                            href="/underconstrution"
                ...
                <div
                  className="slider_right_main tab1-step-5"
                  data-step="5"
                  data-tab-id="tab1-5"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <p>
                          Engage your audience and drive conversions with our
                          effective email marketing campaigns, delivering
                          personalized messages and valuable content to nurture
                ...
                <div
                  className="slider_right_main tab1-step-6"
                  data-step="6"
                  data-tab-id="tab1-6"
                >
                  <div className="row gap-5 align-items-center">
                    ...
                    <div className="col-md-6">
                      <div className="social_ads">
                        ...
                        <h2>E-commerce</h2>
                        <p>
                          Expand your reach and increase sales with our Amazon
                          marketing solutions, leveraging optimization
                          strategies to enhance product visibility and drive
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-md-5">
                ...
                <p
                  className="b2b-text mb-4"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
                  Over a decade of digital marketing experience fuels our
                  strategies, ensuring maximum impact for your brand. Trust our
                  expertise to navigate the complexities of the online landscape
                  and drive tangible results for your business.
                </p>
                <div className="row growBusinessType">
                  <div
                    className="col-lg-6 col-md-6 col-6 d-flex align-items-center"
                    data-aos="fade-up"
                    data-aos-delay="300"
                  >
                    <img src={I1.src} alt="" />
                ...
                <ul className="checkListing">
                  <li data-aos="fade-up" data-aos-delay="300">
                    Collaborated with businesses from various sectors
                  </li>
                  <li data-aos="fade-up" data-aos-delay="300">
                    Small and new businesses are well-served
                  </li>
                  <li data-aos="fade-up" data-aos-delay="300">
                    Define valuable content and marketing channels
                  </li>
                  <li data-aos="fade-up" data-aos-delay="300">
                    Convert the funds you have invested into a priceless asset.
                  </li>
                </ul>
                <div className="mt-5" data-aos="fade-up" data-aos-delay="300">
                  <a className="b2b-btn b2b-btn-sm" onClick={toggleModal}>
                    Request a Quote
                  </a>
                </div>
              </div>
          ...
          <div className="b2b-container-lg">
            <div className="row">
              <div className="col-md-12">
                <h3
                  className="b2b-heading mb-4 text-center"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
                  What a Digital Marketing Services Company Can <br />
            ...
            <div className="row counterWrap mt-5">
              <div
                className="col-md-6 mb-5 counterInnerWrap"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    <div className="counter">
                      <span>01</span>
                      <Link href="/underconstrution" className="box-nav">
                        <span></span>
                      </Link>
                    </div>
                    <h3>Search Engine Optimization (SEO)</h3>
                    <p className="b2b-text mb-4">
                      Enhance online visibility with Base2Brand's SEO expertise.
                      93% of online experiences begin with a search engine. Let
                      our strategies elevate your rankings and boost organic
                      traffic.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    ...
                    <h3>Meta Ads</h3>
                    <p className="b2b-text mb-4">
                      Supercharge your social media presence with targeted
                      Facebook and Instagram Ads. With over 3.5 billion active
                      users combined, these platforms offer unparalleled reach
                      for businesses.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    ...
                    <p className="b2b-text mb-4">
                      We specializes in SMO, optimizing social platforms to
                      enhance brand visibility and engagement, tailored to your
                      business goals.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    ...
                    <p className="b2b-text mb-4">
                      Base2Brand excels in YouTube Marketing, leveraging
                      engaging video content to drive business profits from its
                      vast audience
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    ...
                    <p className="b2b-text mb-4">
                      Base2Brand is your expert in ORM, safeguarding your
                      brand's reputation, addressing negative feedback, and
                      fostering positive sentiments for online success.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="hoverGradient blueGD">
                  <div className=" w-100 h-100 border-bottom">
                    ...
                    <p className="b2b-text mb-4">
                      Our Content Writing service crafts engaging, SEO-friendly
                      content, tailored to your brand across blog posts, website
          ...
          <div className="b2b-container-lg">
            <div className="row gap-5">
              <div className="col-lg-6 col-md-7 order-md-1 order-2">
                <div
                  className="hoverGradient blueGD mb-4 w-100"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
                  <div className="b2b-gray-bg p-3 w-100">
                    ...
                    <p className="b2b-text">
                      We understand that every business is unique, so we craft
                      personalized strategies that align with your goals and
                      objectives, delivering tailored solutions for maximum
                      impact.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="b2b-gray-bg p-3 w-100">
                    ...
                    <p className="b2b-text">
                      ...
                      throughout our partnership, providing regular updates,
                      performance reports, and insights to keep you informed
                ...
                >
                  <div className="b2b-gray-bg p-3 w-100">
                    ...
                    <p className="b2b-text">
                      With a track record of success and satisfied clients, we
                      deliver tangible results that drive business growth,
                      whether it's increased website traffic, higher conversion
                      rates, or improved brand visibility.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="b2b-gray-bg p-3 w-100">
                    ...
                    <p className="b2b-text">
                      We stay ahead of the curve with cutting-edge tools,
                      techniques, and trends in digital marketing, ensuring our
                      strategies are always fresh, relevant, and effective in
            ...
            <div className="row mt-5">
              <div className="col-lg-9 m-auto">
                <h2
                  className="b2b-heading text-center mb-3"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
                  How to Choose a Full-Service Digital Marketing <br />
          ...
          <div className="b2b-container-lg">
            <div className="row">
              ...
              <div className="col-lg-9 m-auto">
                <div className="row counterWrap mt-5">
                  <div
                    className="col-md-6 mb-4 counterInnerWrap"
                    data-aos="fade-up"
                    data-aos-delay="300"
                  >
                    <div className="hoverGradient blueGD">
                      <div className=" w-100 h-100 ">
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              Digital marketing broadens audience reach beyond
                              traditional methods, engaging online communities
                              and potential customers actively, ensuring brand
                        ...
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              ...
                              traditional channels, enabling strategic budget
                              allocation for higher ROI via targeted campaigns.
                            </p>
                          </li>
                        </ul>
                      </div>
                        ...
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              ...
                              interests, ensuring resonant content for higher
                      ...
                      <div className=" w-100 h-100 ">
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              Digital marketing boosts brand visibility and
                              recognition through consistent online presence and
                              strategic branding efforts, fostering trust and
                              loyalty.
                            </p>
                          </li>
                        </ul>
                        ...
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              ...
                              tracking campaign effectiveness, identifying
                              improvement areas, and making data-driven
                              decisions for optimized results.
                            </p>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className=" w-100 h-100 ">
                        <ul className="counter-checklist">
                          <li>
                            ...
                            <p className="b2b-text mb-0">
                              Digital marketing offers flexibility to adjust
                              strategies to changing market trends, consumer
                              preferences, ensuring business agility in dynamic
                  ...
                  <div
                    className="col-lg-12 mt-3 text-center"
                    data-aos="fade-up"
                    data-aos-delay="300"
                  >
                    <button
