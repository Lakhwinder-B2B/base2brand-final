...
export default function Big_Commerce() {
  ...
  return (
    <>  
        <div className="p-5 bg_light_green benefitOuterWrap"> 
            ...
            <div className="row text-white justify-content-center">
              ...
              <div className="col-md-4 mt-md-5 mt-0 order-md-1 order-2">
                <div className="benefit-wrap">
                    <div className="px-3 mt-md-0 mt-4">
              ...
              <div className="col-md-4 mt-md-5 mt-0 order-md-4 order-4">
                    <div className="p-3 pb-3 mt-md-0 mt-4">
        ...
        <div className="py-lg-5 py-3 bg_light_green">
          <div className="container">
