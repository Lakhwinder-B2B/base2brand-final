          ...
          <div className="container"> 
            <div className="row text-white justify-content-center">
              <div className="col-md-12 mx-auto text-center">
                <h2 className="b2b-heading" data-aos="fade-up" data-aos-delay="300">Benefits of a Mobile App For Your Business</h2>
              </div>
              <div className="col-md-4 mt-md-5 mt-0 order-md-1 order-2">
                <div className="benefit-wrap">
                    <div className="px-3 mt-md-0 mt-4" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <p className='b2b-text-sm letterSpacing-1 mb-0'>Mobile apps enable personalized notifications, promotions, and feedback, fostering deeper engagement and understanding of preferences, vital for refining products.</p>
                        
                    </div>
                    <div className="px-3 mt-md-0 mt-4" data-aos="fade-up" data-aos-delay="300">
                        <h4 className='b2b-text-lg'>2. Brand Visibility</h4>
                        <p className='b2b-text-sm letterSpacing-1 mb-0'>Brand Visibility: Well-designed apps strengthen brand recognition and recall, ensuring continuous visibility on customers' screens, essential for staying competitive.</p>
              ...
              <div className="col-md-4 mt-md-5 mt-4 order-md-2 order-1">
                    <img className="w-100" src={benefits.src} alt=""  data-aos="fade-up" data-aos-delay="300"/>
              </div>
              ...
              <div className="col-md-4 mt-md-5 mt-0 order-md-4 order-4">
                    <div className="p-3 pb-3 mt-md-0 mt-4" data-aos="fade-up" data-aos-delay="300">
                        <h4 className='b2b-text-lg'>5. Increased Sales</h4>
                        <p className='b2b-text-sm letterSpacing-1'>Seamless purchasing experiences on mobile apps significantly boost sales, providing convenient access to products or services anytime, anywhere, driving revenue growth.</p>
        ...
        <div className="py-lg-5 py-3 bg_light_green" data-aos="fade-up">
          <div className="container">
              ...
              <div className="col-md-5 mb-md-0 mb-4">
                    <img className="w-100" src={Big2.src} alt=""  data-aos="fade-up" data-aos-delay="300"/>
                  </div> 
                  <div className="col-md-7 text-white"> 
                      <h1 className="b2b-heading mb-3" data-aos="fade-up" data-aos-delay="300">Mobile App Development <br />Services We Offer</h1>
                      <p className="b2b-text-sm letterSpacing-1" data-aos="fade-up" data-aos-delay="300">Our mobile app development services cover iOS, Android, React Native, and Flutter platforms, offering versatile solutions. For iOS, we create sleek, user-friendly experiences optimized for Apple devices, incorporating the latest features. Similarly, our Android expertise ensures seamless performance across a wide range of devices. Additionally, we excel in React Native and Flutter for efficient cross-platform development and visually stunning apps</p>
                  </div>
