         ...
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              ...
              <p className="fs-6 text-left"> Base2Brand exceeded our expectations! Their team&apos;s professionalism and expertise made the entire outsourcing process seamless. They delivered a flawless website that perfectly captured our brand identity.	</p>
        ...
        <div className="container">
         ...
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              <div className="mb-3"> <img className="name_latter" src={name.src} alt="Product" /></div>
              <p className="fs-6 text-left">Impressed with Base2Brand attention to detail and proactive communication. They transformed our vision into a stunning website, demonstrating their commitment to excellence and client satisfaction.</p>
                <div className="d-flex justify-content-end mt-4">
                <div className="right d-flex align-items-center text-right pr-5">
        ...
        <div className="container"> 
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              <div className="mb-3"><img className="name_latter" src={name.src} alt="Product" /></div>
              <p className="fs-6 text-left">Base2Brand exceptional technical proficiency and creative flair truly set them apart. They brought our website to life with innovative design elements and intuitive functionality. Highly recommended!</p>
                <div className="d-flex justify-content-end mt-4">
                <div className="right d-flex align-items-center text-right pr-5">
        ...
        <div className="container">  
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              <div className="mb-3"> <img className="name_latter" src={name.src} alt="Product" /></div>
              <p className="fs-6 text-left">Working with Base2Brand was a game-changer for our business. Their responsive approach, coupled with their strategic insights, resulted in a website that not only looks great but also drives conversions.</p>
                <div className="d-flex justify-content-end mt-4">
                <div className="right d-flex align-items-center text-right pr-5">
        ...
        <div className="container">  
         ...
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              <div className="mb-3"> <img className="name_latter" src={name.src} alt="Product" /></div>
              <p className="fs-6 text-left">Base2Brand collaborative approach and commitment to quality were evident throughout the project. They listened to our needs, provided valuable suggestions, and delivered a website that exceeded our expectations.</p>
                <div className="d-flex justify-content-end mt-4">
                <div className="right d-flex align-items-center text-right pr-5">
        ...
        <div className="container">  
         ...
         <div className="row pl-5 pr-5">
          ...
          <div className="col-md-12" data-aos="fade-right">
            <div className="bg_feedback">
              <div className="mb-3"> <img className="name_latter" src={name.src} alt="Product" /></div>
              <p className="fs-6 text-center">Base2Brand expertise in web development is unmatched. They navigated complex challenges with ease, delivering a robust and scalable solution that has significantly enhanced our online presence. Thank you for your outstanding work!</p>
                <div className="d-flex justify-content-end mt-4">
                <div className="right d-flex align-items-center text-right pr-5">
