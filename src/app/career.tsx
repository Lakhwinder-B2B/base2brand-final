...
export default function home() {
  ...
  return (  
    <>  
      ...
      {/* <div className="container-fluid p-5 mt-0 mt-md-5"> 
          <div className="row text-white"> 
              <div className="col-12 col-sm-12 col-md-4 mb-3" data-aos="flip-left">
              <img className="carrerImg" src={c1.src} alt="Product" />
              </div>
              <div className="col-12 col-sm-12 col-md-4 mb-3"></div>
              <div className="col-12 col-sm-12 col-md-4 mb-3" data-aos="flip-left">
              <img className="carrerImg" src={c2.src} alt="Product" /> 
              </div>
              <div className="col-12 col-sm-12 col-md-9 mt-5 mb-5 mb-lg-0 mt-lg-0 mb-md-0 mt-md-0 mx-auto text-center" data-aos="flip-up">
                  <h2>For Career</h2>
              ...
              <div className="col-12 col-sm-12 col-md-4 mb-3" data-aos="flip-right">
